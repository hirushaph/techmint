  ...
  return (
    <div className='group relative overflow-hidden'>
      <Link to={`/products/${product.slug}`}>
        <div className='overflow-hidden rounded-3xl border border-dark-200 px-2 pb-4 pt-2 transition duration-300 hover:bg-blue-100'>
      ...
      <AnimatePresence>
        {showQuickMenu && (
          <QuickView product={product} onClose={setShowQuickMenu} />
        )}
      </AnimatePresence>
    </div>
  );
